...
function changePink() {
    $("body").css('background-color', '#ffc0cb59');
...
function changeOrange() {
    $("body").css('background-color', '#ffab8c59');
...
function changeYellow() {
    $("body").css('background-color', '#ffee8b59');
...
function changeGreen() {
    $("body").css('background-color', '#cbfdb759');
...
function changeBlue() {
    $("body").css('background-color', '#87cefa59');
